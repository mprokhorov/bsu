...
# Получаем значения параметров a, b, c с клавиатуры
...
# Задаем диапазон и шаг изменения аргумента
...
# Вычисляем и выводим значения функции для каждого значения аргумента
while x_1 <= x_2:
