...
insert into emp values (401, 'Craig McQueen', to_date('29.12.1970','dd-mm-yyyy')); 
insert into emp values (402, 'Stephen Mohr', to_date('25.05.1975','dd-mm-yyyy'));  
insert into emp values (403, 'Jon Martin', to_date('15.07.1968','dd-mm-yyyy')) ;  
insert into emp values (404, 'Richard Martin', to_date('23.02.1970','dd-mm-yyyy'));
insert into emp values (410, 'Robert Grishuk', to_date('15.07.1975','dd-mm-yyyy')); 
insert into emp values (412, 'Vladimir Liss', to_date('18.10.1975','dd-mm-yyyy'));
...
insert into emp values (505, 'Fedor Dikunov', to_date('12.07.1975','dd-mm-yyyy'));
...
insert into career values  (1007, 601, 'B05', to_date('01.07.2019','dd-mm-yyyy'), null);
commit;
/******************************************************/
/*         премия                     */ 
/******************************************************/
