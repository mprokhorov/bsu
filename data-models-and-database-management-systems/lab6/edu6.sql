...
DROP TABLE T_EANALYSIS;
DROP TABLE T_AANALYSIS;
/******************************************************/
/*          подразделения                             */
/******************************************************/
create table dept
...
insert into emp
values (401, 'Craig McQueen', to_date('29.12.1970', 'dd-mm-yyyy'), 'm', 0);
insert into emp
...
insert into bonus
values (101, 10, 2023, 500, null);
insert into bonus
values (102, 10, 2023, 300, null);
insert into bonus
values (103, 10, 2023, 400, null);
insert into bonus
values (215, 10, 2023, 300, null);
insert into bonus
values (601, 10, 2023, 200, null);
insert into bonus
values (403, 10, 2023, 300, null);
commit;
...
(
    period smallint check (period > 0 and period < 13) not null,
    year   integer check (year > 2017 and year < 2024) not null,
    amount real
);
create table t_eanalysis
(
    empno  integer                                     not null,
    year   integer check (year > 2017 and year < 2024) not null,
    amount real
);
create table t_aanalysis
(
    year     integer check (year > 2017 and year < 2024) not null,
    apremium real
);
